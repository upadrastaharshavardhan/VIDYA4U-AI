...
const Home: NextPage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      ...
      <h1 className="text-3xl font-bold">Teach Anything in Seconds</h1>
      <textarea value={desc} onChange={(e) => setDesc(e.target.value)} placeholder={defaultDesc} />

      <DropDown vibe={lang} setVibe={setLang} />
      <DropDown2 vibe2={difficulty} setVibe2={setDifficulty} />

      <button onClick={generateDesc} disabled={loading} className="mt-4 bg-black text-white px-4 py-2">
        {loading ? <LoadingDots color="white" /> : "Generate Answer"}
      </button>
