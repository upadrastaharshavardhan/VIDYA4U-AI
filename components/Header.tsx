  ...
  return (
    <header className="md:flex text-center justify-between items-center w-full mt-5 pb-7 sm:px-4 px-2">
      <Link href="/" className="flex space-x-3 mb-10 md:mb-0 justify-center">
        ...
        VIDYA4U-AI <small className=" font-medium text-base px-2 inline-block bg-fuchsia-500 text-white  rounded-full">HARSHA UPADRASTA</small>
        </h1>
      </Link>
      <div>
         <div className="flex flex-wrap justify-center gap-3 items-center">
          ...
          <a
            ...
            href="https://github.com/upadrastaharshavardhan/VIDYA4U-AI"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Github />
